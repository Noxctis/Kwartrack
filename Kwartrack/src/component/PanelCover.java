...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        // Logo
        JLabel logo = new JLabel(new ImageIcon(getClass().getResource("/com/raven/icon/logo.png"))); // Replace with your logo path
        add(logo, "wrap, center");
        title = new JLabel("Welcome to Kwartrack!");
