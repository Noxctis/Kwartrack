...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        // table1.addRow(new ModelStudent(new
        // ImageIcon(getClass().getResource("/icon/profile2.jpg")), "Bora", "Male",
        // "C#", 300).toRowTable(eventAction));
        // table1.addRow(new ModelStudent(new
        // ImageIcon(getClass().getResource("/icon/profile2.jpg")), "Bora", "Male",
        // "C#", 300).toRowTable(eventAction));
        // table1.addRow(new ModelStudent(new
        ...
        // "C#", 300).toRowTable(eventAction));
        // table1.addRow(new ModelStudent(new
        // ImageIcon(getClass().getResource("/icon/profile1.jpg")), "Bora", "Male",
        // "C#", 300).toRowTable(eventAction));
        // table1.addRow(new ModelStudent(new
        // ImageIcon(getClass().getResource("/icon/profile2.jpg")), "Bora", "Male",
        // "C#", 300).toRowTable(eventAction));
    ...
    private void refreshTableData() {
        try {
            ...
            // Query to get transactions for a specific user along with transaction type and
            // category
            int userId = SessionManager.getInstance().getUserId(); // hardcode for testing, replace with the actual user
                                                                   // ID
            ...
            while (rs.next()) {
                ...
                // Add a row to the table with username, type (Income/Debt/Expense), category
                // (if applicable), etc.
    ...
    private void initCardData() {
        ...
        Icon icon1 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60,
        ...
        // Icon icon1 =
        // IconFontSwing.buildIcon(GoogleMaterialDesignIcons.MONETIZATION_ON, 60, new
        // Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        ...
        // Icon icon3 =
        // IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new
        // Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        // card3.setData(new ModelCard("Expense", 3000, icon3));
        // Icon icon4 =
        // IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new
        // Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
    ...
    private void initNoticeBoard() {
        try {
            ...
            progress1.setValue((int) financialHealthScore);
            ...
            noticeBoard.addNoticeBoard(new ModelNoticeBoard(
                    ...
                    "Your current financial health score is " + String.format("%.2f", financialHealthScore)
                            + "%. Keep up the good work, or consider revising your budget."));
            ...
            noticeBoard.addNoticeBoard(new ModelNoticeBoard(
                    ...
                    formattedDate, // Show the current date
                    "Your total expenses this month are $" + String.format("%.2f", totalExpenses)
                            + ". Consider reviewing your spending habits and cutting back on non-essential items."));
            ...
            noticeBoard.addNoticeBoard(new ModelNoticeBoard(
                    ...
                    "Total Debt", // Title
                    formattedDate, // Show the current date
                    "Your total outstanding debt is $" + String.format("%.2f", totalDebtAsDebtor)
                            + ". Prioritize paying down high-interest debt to improve your financial health."));
            ...
            if (totalExpenses > totalIncome * 0.5) {
                ...
                // "Hidemode", "Now", "Sets the hide mode for the component. If the hide mode
                // has been specified in the This hide mode can be overridden by the component
                // constraint."));
                // noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(218, 49, 238),
                // "Tag", "2h ago", "Tags the component with metadata name that can be used by
                // the layout engine. The tag can be used to explain for the layout manager what
                // the components is showing, such as an OK or Cancel button."));
                // noticeBoard.addDate("03/10/2021");
                // noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(32, 171, 43),
                // "Further Reading", "12:30 PM", "There are more information to digest
                // regarding MigLayout. The resources are all available at
                // www.migcomponents.com"));
                // noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(50, 93, 215),
                // "Span", "10:30 AM", "Spans the current cell (merges) over a number of cells.
                // Practically this means that this cell and the count number of cells will be
                // treated as one cell and the component can use the space that all these cells
                // have."));
                // noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(27, 188, 204),
                // "Skip ", "9:00 AM", "Skips a number of cells in the flow. This is used to
                // jump over a number of cells before the next free cell is looked for. The
                // skipping is done before this component is put in a cell and thus this cells
                // is affected by it. \"count\" defaults to 1 if not specified."));
                // noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(238, 46, 57),
                // "Push", "7:15 AM", "Makes the row and/or column that the component is
                // residing in grow with \"weight\". This can be used instead of having a
                // \"grow\" keyword in the column/row constraints."));
    ...
    // Example method to calculate the financial health score based on income,
    // expenses, and debt
    ...
    private void initComponents() {
        ...
        progress1 = new swing.progress.Progress();
        ...
        jLabel5.setText("Financial Health Score");
                ...
                panelTransparent1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelTransparent1Layout.createSequentialGroup()
                                ...
                                .addGroup(panelTransparent1Layout
                                        ...
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 528,
                                                Short.MAX_VALUE)
                                        .addGroup(panelTransparent1Layout.createSequentialGroup()
                                                .addComponent(dashboardBalanceButton,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 134,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(dashboardExpenseButton,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 134,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(dashboardDebtButton,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 134,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                panelTransparent1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelTransparent1Layout.createSequentialGroup()
                                ...
                                .addGroup(panelTransparent1Layout
                                        ...
                                        .addComponent(dashboardBalanceButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(dashboardExpenseButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(dashboardDebtButton, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                panelTransparent2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelTransparent2Layout.createSequentialGroup()
                                ...
                                .addGroup(panelTransparent2Layout
                                        ...
                                        .addComponent(noticeBoard, javax.swing.GroupLayout.Alignment.TRAILING,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                panelTransparent2Layout.createSequentialGroup()
                ...
                panelTransparent2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(panelTransparent2Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 1,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(1, 1, 1)
                                .addComponent(noticeBoard, javax.swing.GroupLayout.DEFAULT_SIZE, 440, Short.MAX_VALUE)
                                .addContainerGap()));

        progress1.setBackground(new java.awt.Color(76, 97, 142));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                ...
                                                .addComponent(panelTransparent1, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(layout
                                                ...
                                                .addComponent(progress1, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGap(32, 32, 32)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(panelTransparent2, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(panelTransparent1, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap()));
    ...
    private swing.progress.Progress progress1;
