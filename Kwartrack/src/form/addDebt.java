...
public class addDebt extends javax.swing.JFrame {
    ...
    try {
        // Assume debtorId is the logged-in user's ID
        int debtorId = 1; // Replace with actual debtor's user ID
        int creditorId = 2; // Replace with the actual creditor's user ID (e.g., fetched based on the name input)
