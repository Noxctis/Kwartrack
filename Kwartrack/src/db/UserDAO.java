...
public class UserDAO {
    ...
    // Optional: Transaction management for registering a user (if needed for atomic operations)
    public boolean registerUserWithTransaction(String username, String email, String password, String firstname, String lastname) {
        String insertQuery = "INSERT INTO users (username, email, password_hash, firstname, lastname) VALUES (?, ?, ?, ?, ?)";
